...
> GitHub found _ vulnerabilities on <USERNAME.github.io>'s default branch (_ high, _ moderate, _ low). To find out more, visit: 
>```
>https://github.com/<USERNAME>/<USERNAME>.github.io/security/dependabot
>```
